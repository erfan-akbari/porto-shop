...
function Shop__aside_menu() {
    return (
        <aside className="Name='hidden lg:flex basis-[25%] h-fit border p-4 md:sticky top-16'>
            <div>
                {/* accordion */}
                ...
                <div className="p-5">
                    ...
                    <p className="Name='text-slate-500 '>
...
export default Shop__aside_menu